...
public class Shooter {
    ...
    public void electronicStatus(){
        ...
        // These are relative to standing on the opposite of the shooter

        ShuffleDash.update("Right Shooter Motor", seeIfElectronicHasInput(shooterMotorRight));
        ShuffleDash.update("Left Shooter Motor", seeIfElectronicHasInput(shooterMotorLeft));
        ShuffleDash.update("Intake Motor", seeIfElectronicHasInput(intake));
    }
